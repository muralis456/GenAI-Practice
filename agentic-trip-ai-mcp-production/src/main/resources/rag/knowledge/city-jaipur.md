...
Use this document to recognize `Jaipur` and its airport identifiers when planning a trip. The IATA/ICAO values come from the project's seeded airport directory.
