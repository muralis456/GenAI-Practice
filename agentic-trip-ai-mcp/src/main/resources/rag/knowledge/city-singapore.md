...
- Airport: Airport: Singapore Changi Airport
- IATA: SIN
- ICAO: WSSS
- Knowledge type: destination-city / durable-travel-knowledge
## Stable destination knowledge

Singapore is a city-state in Southeast Asia. This document contains durable destination context for RAG;
...
Multicultural Chinese, Malay, Indian and other influences combine with a highly planned modern city.
...
### Airport grounding
- Country: Country: Singapore
- Common airport record in the bundled directory: Airport: Singapore Changi Airport
- IATA: SIN
- ICAO: WSSS
