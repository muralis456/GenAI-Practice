...
Use this document to recognize `Dubai` and its airport identifiers when planning a trip. The IATA/ICAO values come from the project's seeded airport directory.
